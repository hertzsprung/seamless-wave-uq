...
\rev{These tests demonstrated that the stochastic Galerkin model preserves discrete balance between flux and topography gradients to machine precision, and accurately reproduces steady flow over highly irregular and uncertain topography.}
