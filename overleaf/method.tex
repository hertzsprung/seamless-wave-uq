...
\rev{Equation~\eqref{eqn:swe} represents hydraulic flow in an idealised, frictionless channel with a rectangular cross-section.}
...
\rev{Consequently, the deterministic model is able to simulate subcritical, supercritical and transcritical flows.}
