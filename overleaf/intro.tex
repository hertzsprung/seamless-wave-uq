...
\rev{The model uses a stochastic reformulation of the surface gradient method \citep{zhou2001}, and the well-balancedness of this reformulation} is studied theoretically and verified numerically for \rev{an idealised, motionless lake-at-rest over an uncertain bed}.
