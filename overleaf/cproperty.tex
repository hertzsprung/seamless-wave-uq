...
\rev{A lake at rest is an idealised scenario where the free-surface is entirely flat and motionless, much like still water in a lake.}
Assuming a lake-at-rest \rev{for the stochastic model}, the mean free-surface elevation is constant and the mean discharge is zero, and there is no uncertainty in the free-surface elevation or discharge.
