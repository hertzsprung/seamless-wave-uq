...
\newcommand{\rev}[1]{\textcolor{orange}{\textbf{#1}}}
%\newcommand{\TODO}[1]{\textcolor{purple}{\textit{TODO: #1}}}
...
\title{\rev{Stochastic Galerkin finite volume shallow flow model with well-balanced treatment of uncertain topography using the surface gradient method}}
