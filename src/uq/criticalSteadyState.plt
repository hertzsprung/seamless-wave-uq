...
set multiplot layout 3,2 spacing 0.1,0.1 margin 0.16,0.98,0.07,0.9
...
plot "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:($2-$5):($2+$5) with filledcurves lc rgbcolor '#BBBBBB' notitle, \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:2 lc rgbcolor 'black' lw 3 title 'Topography', \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:($3-$6):($3+$6) with filledcurves lw 3 lc rgbcolor '#9acae1' notitle, \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:3 lw 3 lc rgbcolor '#2171b5' title 'Water elevation'
...
plot "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:($4-$7):($4+$7) with filledcurves lc rgbcolor '#a1d99b' notitle, \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo.dat" using 1:4 lc rgbcolor '#238b45' lw 3
