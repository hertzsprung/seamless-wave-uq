...
plot "`echo $uqdata_builddir`/uq/criticalSteadyState-wellBalancedH-3/statistics.dat" using 1:($2-$5):($2+$5) with filledcurves lc rgbcolor '#BBBBBB' notitle, \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-wellBalancedH-3/statistics.dat" using 1:2 lc rgbcolor 'black' lw 4 title 'Mean', \
     NaN with filledcurves lc rgbcolor '#BBBBBB' title 'Std. deviation', \
     ...
     NaN lw 6 lc rgbcolor '#0072d3' title 'Mean', \
     NaN with filledcurves lw 3 lc rgbcolor '#b0d6e8' title 'Std. deviation', \
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo/derived-statistics.dat" using 1:2 with points lc 7 lw 2 pt 7 ps 1 title 'Mean', \
     ...
     "`echo $uqdata_builddir`/uq/criticalSteadyState-monteCarlo/derived-statistics.dat" using 1:($2-$3) lw 4 lc 7 dt (3, 2) title 'Std. deviation', \
